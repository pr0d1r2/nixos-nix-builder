...
| B25 | 2026-09-26 | actionlint lefthook wrapper executed in CI without `actionlint` in the development shell, causing guardrails to exit 127 after the checks ran | fixed: add the pinned nixpkgs actionlint package to the consumer development shell |
